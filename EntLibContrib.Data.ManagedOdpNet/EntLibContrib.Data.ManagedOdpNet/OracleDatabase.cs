...
using EntLibContrib.Data.ManagedOdpNet.Configuration.Unity;
using EntLibContrib.Data.ManagedOdpNet.Properties;
...
namespace EntLibContrib.Data.ManagedOdpNet
{
    ...
    /// <remarks>
    /// <para>
    /// Internally uses an ODP.NET Managed Provider from Oracle (<see cref="Oracle.ManagedDataAccess.Client"/>) to connect to an Oracle 9i, or newer, database.
    /// </para>
    /// <para>
    ...
    private XmlReader DoExecuteXmlReader(OracleCommand oracleCommand)
    {
      ...
      catch (Exception e)
      {
        ...
        /// <param name="args">The <see cref="Oracle.ManagedDataAccess.Client.OracleRowUpdatedEventArgs"/> instance containing the event data.</param>
        /// <remarks>
